    ...
    <view class="calendar-cell">
        ...
        >
            ...
            >
                ...
                >
                    {{ item.date | numberPad }}
                    <calendar-marker v-if="markers[item.format]" :config="markers[item.format]" />
                </view>
            </view>
        </view>
        <!-- 月 -->
        ...
        >
            ...
            >
                <view class="text flex-center sy-ui-din-medium">
                    {{ month + 1 }}{{ dict.month }}
                    <calendar-marker v-if="markers[getMonthFormat(month)]" :config="markers[getMonthFormat(month)]" />
                </view>
            </view>
        </view>
        <!-- 年 -->
        ...
        >
            ...
            >
                <view class="text flex-center sy-ui-din-medium">
                    {{ year }}
                    <calendar-marker v-if="markers[year]" :config="markers[year]" />
                </view>
            </view>
        </view>
    </view>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            isRange() {
                return this.calendarProps.mode === 'range'
            },
            selected() {
