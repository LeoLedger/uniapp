...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 设置数据源
            setOptions(options = this.__props.options) {
            ...
            updateViewValue() {
                if (this.isEmpty(this.__props.value)) {
                    this.viewValue = ''
                } else {
                    ...
                    case 'multiSelector':
                        ...
                        break
                    case 'linkage':
                        if (this.rootNodes && this.__props.value) {
                            var value = this.__props.emitPath ? this.__props.value.slice(-1)[0] : this.__props.value
